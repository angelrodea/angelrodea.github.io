<?php 
    include("../template/adm_header.php");
    include("../db/db.php");
?>
    <main>  
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        <a class="nav-link" id="v-pills-datos-tab" data-bs-toggle="pill" href="#v-pills-datos" 
                            role="tab" aria-controls="v-pills-datos" aria-selected="true">
                            Datos
                        </a>
                        <a class="nav-link active" id="v-pills-doc-tab" data-bs-toggle="pill" href="#v-pills-doc" role="tab" 
                ...
                <div class="col-md-9">
                    <div class="tab-content" id="v-pills-tabContent">
                        <div class="tab-pane fade bg-border border border-dark rounded-3 p-3" id="v-pills-datos" 
                        ...
                        <div class="tab-pane fade show active p-3" id="v-pills-doc" role="tabpanel" aria-labelledby="v-pills-doc-tab">
                            <!------------- DOCUMENTOS ------------------>
                            <div class="container">
                                <div class="mb-3">
                                    <table class="table table-striped table-bordered">
                                        ...
                                        <tbody class="table-group-divider">
                                            <?php
                                                $query = "SELECT id_documento, documento, archivo, validacion FROM documento 
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select class="text-capitalize" disabled>
                                                            <option selected><?php echo $validacion?></option>
                                                        </select>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                    ...
                                    <center>
                                        <button name="btnComment" class="btn btn-primary" disabled>
                                            Validar documentos
                                        </button>
                                    </center>
                                </div>

                                <form method="POST" action="../db/update_docPagoMedicoValidacion.php">
                                    <div class="mb-5">
                                        ...
                                        <table class="table table-striped table-bordered">
                                            ...
                                            <tbody class="table-group-divider">
                                                <?php
                                                    $grado = $grupos[0] + 1 . "°";
                                                    $query = "SELECT id_documento, documento, archivo, validacion, fecha
                                                            FROM documento
                                                            WHERE id_alumno = $id AND documento = 'Certificado Médico'
                                                            ORDER BY fecha DESC
                                                            LIMIT 1;";
                                                    $result = $connection->query($query);
                                                ...
                                                ?>
                                                    <tr>
                                                        <td scope="row">
                                                            <?php echo $grado?>
                                                            <!--<select name="gradoPago" id="gradoPago">
                                                        ...
                                                        <td><a href="<?php echo $archivo?>"><?php echo $nombreArchivo?></a></td>
                                                        <td>
                                                            <select name="docMedico" id="<?php echo $idDoc?>">
                                                                <option selected>Seleccionar</option>
                                                                <option value="aceptado">Aceptado</option>
                                                                <option value="rechazado">No aceptado</option>
                                                            </select>
                                                            <input type="hidden" name="idDocMedico" value="<?php echo $idDoc ?>">
                                                        </td>
                                                    </tr>
                                                <?php } ?>
                                            </tbody>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <table class="table table-striped table-bordered">
                                            ...
                                            <tbody class="table-group-divider">
                                                <?php
                                                    $query = "SELECT id_documento, documento, archivo, validacion, fecha 
                                                            FROM documento 
                                                            WHERE id_alumno = 50 AND documento = 'Comprobante de pago'
                                                            ORDER BY fecha DESC
                                                            LIMIT 1;";
                                                    $result = $connection->query($query);
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><a href="<?php echo $archivo?>"><?php echo $nombreArchivo?></a></td>
                                                        <td>
                                                            <select name="docPago" id="<?php echo $idDoc?>">
                                                                <option selected>Seleccionar</option>
                                                                <option value="aceptado">Aceptado</option>
                                                                <option value="rechazado">No aceptado</option>
                                                            </select>
                                                            <input type="hidden" name="idDocPago" value="<?php echo $idDoc ?>">
                                                        </td>
                                                    </tr>
                                                <?php } ?>
                                            </tbody>
                                        ...
                                        <center>
                                            <button type="submit" name="btnValid" class="btn btn-primary">
                                                Validar documentos
                                            </button>
                                        </center>
                                    </div>
