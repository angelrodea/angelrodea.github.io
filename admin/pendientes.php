                    ...
                    <tbody>
                        <?php
                            ...
                            $query = "SELECT a.id_alumno, a.nombre, a.ap_paterno, a.ap_materno, g.grupo, a.curp FROM alumno a
                                    INNER JOIN grupo g ON a.id_grupo = g.id_grupo WHERE a.status = 'pendiente'";
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                $queryDocumento = "SELECT documento, validacion FROM documento 
                                                ...
                                                IN ('Comprobante de pago', 'Certificado Médico') order by fecha DESC limit 2";
                        ...
                        <tr>
                            ...
                            <td><?php echo $curp?></td>
                            <td>
                                <a href="docs_solicitante.php?id=<?php echo $id?>">
                                    Ver archivos
                                </a>
                            </td>
                            <td>
                            <button type="button" class="btn btn-success" 
                                onclick="location.href='../db/update_statusAlumno.php?id2=<?php echo $id?>';" 
                                    <?php validation($valido)?>>
                                    Aceptar
                            </button>
