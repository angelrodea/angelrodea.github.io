                                                        ...
                                                        <table class="table table-striped table-bordered">
                                                            ...
                                                            <tbody class="table-group-divider">
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <select name="docInscripcion" id="docInscripcion" disabled>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <select name="docBoleta" id="docBoleta" disabled>
                                                                            <option selected>Aceptado</option>
                                                                        </select>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <select name="docKinder" id="docKinder" disabled>
                                                                            <option selected>Aceptado</option>
                                                                        </select>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <select name="docCurp" id="docCurp" disabled>
                                                                            <option selected>Aceptado</option>
                                                                        </select>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <select name="docActaNac" id="docActaNac" disabled>
                                                                            <option selected>Aceptado</option>
                                                                        </select>
                                                                    </td>
                                                                </tr>
                                                    ...
                                                    <form action="">
                                                        ...
                                                        <table class="table table-striped table-bordered">
                                                            ...
                                                            <tbody class="table-group-divider">
                                                                <tr>
                                                                    <td scope="row">
                                                                        <select name="gradoMedico" id="gradoMedico">
                                                                            <option selected>Seleccionar</option>
                                                                            <option value="1">1°</option>
                                                                            <option value="2">2°</option>
                                                                            <option value="3">3°</option>
                                                                    ...
                                                                    <td><a href="#">certificado.pdf</a></td>
                                                                    <td>
                                                                        <select name="docMedico" id="docMedico">
                                                                            <option selected>Seleccionar</option>
